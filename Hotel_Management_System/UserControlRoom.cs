...
namespace Hotel_Management_System
{
    public partial class UserControlRoom : UserControl
    {
        ...
        {
            db.DisplayAndSearch("SELECT * FROM Room_Table", dataGridSearchRoom);
        }
        ...
        {
            db.DisplayAndSearch("SELECT * FROM Room_Table WHERE Room_Number LIKE '%" + textBoxSearchRoomNo.Text + "%'", dataGridSearchRoom);
        }
        ...
        private void dataGridViewRoom_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if(e.RowIndex != -1)
            {
                DataGridViewRow row = dataGridSearchRoom .Rows[e.RowIndex];
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            if (No != "")
            {
                ...
                {
                    DialogResult result = MessageBox.Show("Are you want delete this room?", "Delete This Room", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
